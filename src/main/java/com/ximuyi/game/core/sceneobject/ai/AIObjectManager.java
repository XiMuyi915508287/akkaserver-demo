...
import com.ximuyi.game.core.bt.BTManager;
import com.ximuyi.game.core.bt.BTNode;
import com.ximuyi.game.core.sceneobject.ai.action.AIObjectFactory;
...
public class AIObjectManager extends BTManager<AIObjectContext> {
    ...
    private void loadConfigs() {
        String baseDirPath = Configs.getInstance().getFilePath("resources/json/ai_object");
        File baseDir = new File(baseDirPath);
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("type", "Selector");
        jsonObject.put("random", 1000);
